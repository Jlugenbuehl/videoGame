...
//THE ONES ABOVE ARE OK TO KEEP IN FUNCTIONS
   /* public static void scheduleActions(Entity entity, ) {
        switch (entity.kind) {
            case DUDE_FULL:
...
*/
   ...
   /* public static void parseSaveFile(WorldModel world, Scanner saveFile, ImageStore imageStore, Background defaultBackground){
    ...
    /*public static void shiftView(WorldView view, int colDelta, int rowDelta) {
        int newCol = Action.clamp(view.viewport.col + colDelta, 0, view.world.numCols - view.viewport.numCols);
        int newRow = Action.clamp(view.viewport.row + rowDelta, 0, view.world.numRows - view.viewport.numRows);
